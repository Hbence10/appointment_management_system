...
//        CsrfTokenRequestAttributeHandler csrfTokenRequestAttributeHandler = new CsrfTokenRequestAttributeHandler();
        ...
        http
                ...
                .authorizeHttpRequests((requests) -> requests
                        ...
                        .requestMatchers("/admin/closeRoomForADay", "/admin/closeRoomBetweenPeriod", "/admin/closeByRepetitiveDates", "/admin/closeReasons", "/admin/makeCloseReasons", "/admin/shortList").hasRole("superAdmin")
                        ...
                        .requestMatchers("/makeAdmin/**", "/admin", "/admin/updateAdmin", "/admin/deleteAdmin/**", "/openingDetails/update", "/details/update").hasRole("superAdmin")
...
//                .addFilterAfter(new CsrfCookieFilter(), BasicAuthenticationFilter.class)
                ...
                .addFilterBefore(new JWTTokenValidatorFilter(refreshTokenService), BasicAuthenticationFilter.class)
